// import { NEWSLETTER_001 as newsletter_001 } from './newsletter-001';

const NEWSLETTER_001: string = `<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <tbody>
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr class="header">
                                <td align="left" valign="top" >
                                    <img src="https://tai-dye-studios.com/assets/images/icon/logo-shirt_230x93.png" class="main-logo">
                                </td>
                                <td class="menu" align="right">
                                    <ul>
                                        <li style="display: inline-block;text-decoration: unset"><a href="#" style="text-transform: capitalize;color:#444;font-size:16px;margin-right:15px;text-decoration: none;">Home</a></li>
                                        <li style="display: inline-block;text-decoration: unset"><a href="#" style="text-transform: capitalize;color:#444;font-size:16px;margin-right:15px;text-decoration: none;">Whishlist</a></li>
                                        <li style="display: inline-block;text-decoration: unset"><a href="#" style="text-transform: capitalize;color:#444;font-size:16px;margin-right:15px;text-decoration: none;">my cart</a></li>
                                        <li style="display: inline-block;text-decoration: unset"><a href="#" style="text-transform: capitalize;color:#444;font-size:16px;margin-right:15px;text-decoration: none;">Contact</a></li>
                                    </ul>
                                </td>
                            </tr>
                        </table>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td><img src="assets/images/email-temp/1.jpg" alt="" style="width: 100%;"></td>
                            </tr>
                        </table>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:30px;">
                            ...
                            <tr>
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0">
                                            <img src="assets/images/email-temp/pro-1.jpg" alt="product" style="width: 170px;">
                                        </div>
                                ...
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0">
                                            <img src="assets/images/email-temp/pro-2.jpg" alt="product" style="width: 170px;" class="img-fluid">
                                        </div>
                                        <div class="product-info">
                                            <div class="rating">
                                ...
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0">
                                            <img src="assets/images/email-temp/pro-3.jpg" alt="product" style="width: 170px;" class="img-fluid">
                                        </div>
                                        <div class="product-info">
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr align="center">
                                    <td>
                                        <a href="#"><img src="assets/images/email-temp/cosmetic.jpg" style="width:100%;"></a>
                                    </td>
                                </tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:30px;">
                            <tbody>
                                <tr align="center" class="add-with-banner">
                                    <td>
                                        <a href="#"><img src="assets/images/email-temp/6.png" style="width:100%;"></a>
                                    </td>
                                    <td>
                                        <a href="#"><img src="assets/images/email-temp/5.png" style="width:100%;"></a>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <td style="padding: 30px;">
                                    ...
                                    <table  border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;" >
                                        <tr>
                                            <td>
                                                <a href="#" style="font-size:13px">Unsubscribe</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
...
const NEWSLETTER_002: string = ``
const NEWSLETTER_003: string = ``
const NEWSLETTER_004: string = ``
export const Newsletters: any = {
    NEWSLETTER_001,
    NEWSLETTER_002,
    NEWSLETTER_003,
    NEWSLETTER_004,
